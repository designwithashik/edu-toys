...
const Banner = () => {
    return (
        <div className='flex mt-5 mb-28'>
            <div className='w-full'>
                <h2 className=' text-5xl lg:mt-32 text-purple-600'>Fun to learn,</h2>
            ...
            <div className="w-full relative flex">
                ...
                <div className="w-20 right-20 top-14  absolute h-20 bg-accent rounded-full"></div>
                <div className="w-12 right-40 top-4  absolute h-12 bg-[#FF1276] rounded-full"></div>
