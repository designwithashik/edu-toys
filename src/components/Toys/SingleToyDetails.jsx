...
const SingleToyDetails = () => {
    ...
    return (
        <div className='flex flex-col border-8 md:flex-row items-center justify-center border-purple-400 rounded-box md:py-12 my-9  px-12 py-52 gap-5 min-h-[calc(100vh-400px)]'>
